...
COMPETITOR_SCRAPERS: dict[str, type] = {
    ...
    "el_corte_ingles": ElCorteInglesScraper,
}
...
Ejemplos:
  ...
  python main.py --scrapers boutique amazon mediamarkt apple_store samsung_store el_corte_ingles
  python main.py --scrapers boutique --test     # Prueba rápida
...
Scrapers disponibles:
  boutique (fuente principal), grover, rentik, amazon, mediamarkt, apple_store, samsung_store, movistar, orange, el_corte_ingles
        """,
    )
    parser.add_argument(
        "--scrapers", nargs="+",
